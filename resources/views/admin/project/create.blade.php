                    ...
                    <div class="bg-white rounded-lg relative">
                        <div class="flex items-start p-5 border-b rounded-t">
                            <div class="flex items-center mb-4">
                                <h3 class="text-2xl font-bold leading-none text-gray-900">Новый проект</h3>
                            </div>
                        </div>
                            ...
                            <form method="POST" enctype="multipart/form-data" action="{{ route('admin.project.store') }}">
                                ...
                                <div class="grid grid-cols-6 gap-6">
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text" name="name" id="name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" required :value="old('name')">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <label for="donations_need" class="text-sm font-medium text-gray-900 block mb-2">Нужно средст</label>
